...
use Juanparati\BrevoSuite\Contracts\TemplateTransport as BrevoSuiteTemplateTransportContract;


/**
 * Email transport used for Brevo templates.
 *
 * @package Juanparati\BrevoSuite
 */
class TemplateTransport implements BrevoSuiteTemplateTransportContract
{
    ...
    /**
     * Transforms into Brevo SendSmtpEmail.
     *
    ...
    /**
     * Convert address pair into Brevo models.
     *
     * @param array $source
     * @param string $type
     * @return array
